...
--
-- Host: 192.168.0.118    Database: ejercicio9
-- ------------------------------------------------------
...
CREATE TABLE `asignado_a` (
  ...
  CONSTRAINT `asignado_a_ibfk_1` FOREIGN KEY (`cientifico`) REFERENCES `cientifico` (`dni`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2022-10-20 12:58:29
