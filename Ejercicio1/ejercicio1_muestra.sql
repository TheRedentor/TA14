...
--
-- Host: 192.168.0.118    Database: ejercicio1
-- ------------------------------------------------------
...
CREATE TABLE `muestra` (
  ...
  `precipitaciones` char(30) DEFAULT NULL,
  `humedad_minima` double DEFAULT NULL,
  `humedad_maxima` double DEFAULT NULL,
  `velocidad_viento_minima` double DEFAULT NULL,
  `velocidad_viento_maxima` double DEFAULT NULL,
  `identificador_estacion` int NOT NULL,
...
-- Dump completed on 2022-10-20 12:58:43
