...
--
-- Host: 192.168.0.118    Database: ejercicio3
-- ------------------------------------------------------
...
CREATE TABLE `articulo` (
  ...
  CONSTRAINT `articulo_ibfk_1` FOREIGN KEY (`codigo_fabricante`) REFERENCES `fabricante` (`codigo_fabricante`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-10-20 12:58:22
