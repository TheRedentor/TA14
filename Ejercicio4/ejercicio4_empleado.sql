...
--
-- Host: 192.168.0.118    Database: ejercicio4
-- ------------------------------------------------------
...
CREATE TABLE `empleado` (
  ...
  CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`codigo_departamento`) REFERENCES `departamento` (`codigo_departamento`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-10-20 12:58:34
